...
namespace quanly.lopdulieu
{
    public class TimKiem
    {
        ...
        public DataSet coban(string strtk)
        {
            ...
            return dl.getdata("select sach.MaTaiLieu as ' Mã Sách',sach.NhanDe as 'Nhan Đề',TacGia.TenTacGia as 'Tên tác giả',NgonNgu.NgonNgu as 'Ngôn ngữ',sach.SoLuong as 'Sách còn',ViTriluutru.kho, ViTriluutru.ke as 'Kệ',ViTriluutru.ngan as 'Ngăn' from TacGia,TheLoai,NgonNgu,sach,ViTriluutru where sach.MaViTri = ViTriluutru.MaViTri and sach.MaTheLoai = TheLoai.MaTheLoai and TacGia.MaTacGia = sach.MaTacGia and sach.MaNgonNgu = NgonNgu.MaNgonNgu and (sach.NhanDe like N'%" + strtk + "%' or TacGia.TenTacGia like N'%" + strtk + "%' or sach.MaTaiLieu='"+ strtk+"')");

        }
        public DataSet nangcao(string strsach, string TacGia, string strTheLoai, string strNgonNgu)
        {
            string strkn = "select sach.MaTaiLieu as ' Mã Sách',sach.NhanDe as 'Nhan Đề',TacGia.TenTacGia as 'Tên tác giả',NgonNgu.NgonNgu as 'Ngôn ngữ',sach.SoLuong as 'Sách còn',ViTriluutru.kho, ViTriluutru.ke as 'Kệ',ViTriluutru.ngan as 'Ngăn' from TacGia,TheLoai,NgonNgu,sach,ViTriluutru where sach.MaViTri = ViTriluutru.MaViTri and sach.MaTheLoai = TheLoai.MaTheLoai and TacGia.MaTacGia = sach.MaTacGia and sach.MaNgonNgu = NgonNgu.MaNgonNgu and sach.NhanDe like N'%" + strsach + "%' ";
